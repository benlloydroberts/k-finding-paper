...
\begin{table}[!t]
	...
	\begin{tabular}{rrrrr}
		...
		\multicolumn{1}{c}{\begin{tabular}[c]{@{}c@{}}States\\ (Theoretical)\end{tabular}} & \multicolumn{1}{c}{\begin{tabular}[c]{@{}c@{}}States\\ (Reachable)\end{tabular}} & \multicolumn{1}{c|}{Actions} & \multicolumn{1}{c}{Depth} & \multicolumn{1}{c}{\begin{tabular}[c]{@{}c@{}}Coverage (\%) \\ reachable states\end{tabular}} \\ \hline
