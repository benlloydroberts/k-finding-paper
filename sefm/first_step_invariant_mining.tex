...
\todo{Subsec: Explain stacked trajectories}
\todo{What data is generated?}
\todo{How is the data generated}
\todo{What information is held by trajectories?}
\todo{Why are they stacked?}
...
\subsection{Environment Generation} \todo{Move to results, refer to why they were used \& shorten}
...
\todo{Swap out for illustration of stacked trajectories}
\begin{figure*}[!t]
	\centering
...
\todo{Add fig: covariance / phi matrix}
