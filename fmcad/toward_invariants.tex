...
\todo{Right-justified columns for numerical results}
\todo{Equalise decimal places in results}
...
In this work, we firstly formulate the theoretical and practical frameworks to represent interlocking verification as a goal-orientated reinforcement learning task and secondly, devise an appropriate strategy for learning invariants within those frameworks. \todo{Rephrase RL as framework for learning invariants, not the actual learning strategy} \todo{Elaborate on invariant finding problem}
\todo{Strengthen link between coverage metrics and invariant mining}
...
\todo[inline]{Add specifics of BMC, Ladder logic and interlockings }
...
\todo[inline]{More comprehensive explanation of RL and its components}
...
\todo{Verify whether coverage metrics generalise to real world problems}
