...
\begin{figure*}[!t]
\centering
\subfloat[Number of reachable states discovered during five hours of training.]{\includegraphics[width=\columnwidth]{figs/reachable_states.png}%
	\label{fig_first_case}}
\subfloat[Max state space depth observed over 25 thousand training episodes.]{\includegraphics[width=\columnwidth]{figs/max_k.png}%
	\label{fig_second_case}}
\hfil
\subfloat[Mean policy entropy loss. The negative average entropy output by the policy network.]{\includegraphics[width=\columnwidth]{figs/entropy.png}%
	\label{fig_first_case}}
\subfloat[Rolling average of reward for 35 thousand training episodes.]{\includegraphics[width=\columnwidth]{figs/reward.png}%
	\label{fig_second_case}}
